...
<div class="flex items-center justify-between gap-2">
	<div class="flex items-center gap-2">
		<p class="text-2xl my-2 dark:text-primary-400">Repo Diagnostics</p>
...
<Card
	class="w-full p-4 sm:p-4 max-w-full dark:bg-secondary-600 max-h-screen overflow-auto border-0 shadow-none"
>
	<Accordion
		activeClass="dark:hover:bg-secondary-700 focus:ring-0 text-white overflow-auto py-2"
		inactiveClass="dark:hover:bg-secondary-700 text-white py-2"
		class="w-full"
	>
